...
const Register: NextPage = () => {
    ...
    const formSchema = Yup.object().shape({
        ...
        password: Yup.string()
            .min(6, 'Votre mot de passe doit comporter au minimum 6 caracteres')
            .required('Required'),
        confirmPassword: Yup.string()
            .min(6, 'Votre mot de passe doit comporter au minimum 6 caracteres')
            .oneOf([Yup.ref('password'), null], "Vos mots de passe ne corespondent pas")
            .required('Required'),
    });
    ...
    const signUp = (values: Values) => {
        ...
        axios
            ...
            .then((data) => {
                ...
                setNotif({
                    success: true,
                    message: 'Insciption réussie. Bienvenue sur votre boutique Nioudem!',
                });
    ...
    return (
        <div>
            <Head>
                <title>Nioudem Boutique: Connexion ou Inscription</title>
